...
typedef unsigned int	UTF32_t;	/* at least 32 bits */
typedef unsigned short	UTF16_t;	/* at least 16 bits */
typedef unsigned char	UTF8_t;		/* typically 8 bits */
...
ConversionResult ConvertUTF16toUTF8 (
		...
		UTF8_t** targetStart, UTF8_t* targetEnd, ConversionFlags flags);
...
Boolean isLegalUTF8Sequence(const UTF8_t *source, const UTF8_t *sourceEnd);
