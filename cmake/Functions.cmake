...
FUNCTION(APPLY_SCGMS_LIBRARY_BUILD_SETTINGS TARGET_NAME)
	...
	IF(WIN32)
		SEPARATE_ARGUMENTS(TARGET_COMPILE_FLAGS_STR WINDOWS_COMMAND "${TARGET_COMPILE_FLAGS_STR}")
		SEPARATE_ARGUMENTS(TARGET_COMPILE_FLAGS_DEBUG_STR WINDOWS_COMMAND "${TARGET_COMPILE_FLAGS_DEBUG_STR}")
		SEPARATE_ARGUMENTS(TARGET_COMPILE_FLAGS_RELEASE_STR WINDOWS_COMMAND "${TARGET_COMPILE_FLAGS_RELEASE_STR}")
	ELSE()
		SEPARATE_ARGUMENTS(TARGET_COMPILE_FLAGS_STR UNIX_COMMAND "${TARGET_COMPILE_FLAGS_STR}")
		SEPARATE_ARGUMENTS(TARGET_COMPILE_FLAGS_DEBUG_STR UNIX_COMMAND "${TARGET_COMPILE_FLAGS_DEBUG_STR}")
		SEPARATE_ARGUMENTS(TARGET_COMPILE_FLAGS_RELEASE_STR UNIX_COMMAND "${TARGET_COMPILE_FLAGS_RELEASE_STR}")
	ENDIF()
