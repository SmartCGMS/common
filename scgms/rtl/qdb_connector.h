...
/* note: this file is included only if build with Qt framework is requested */
...
/* implementation of Qt database query */
...
/* implementation of Qt database connection */
...
/* sets up a filter, implementing the IDb_Sink inspection interface, for database access */
