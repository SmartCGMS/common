...
class CDynamic_Library final {
	...
	public:
		...
		/* resolves symbol from loaded module and casts it to the given type; returns nullptr if no such symbol found or no module loaded */
		template<typename T>
		...
		/* retrieves platform-specific library extension */
