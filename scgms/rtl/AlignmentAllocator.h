...
/* default alignment of AVX2-capable machines */
const size_t AVX2Alignment = 64;

/* allocator to use for aligned allocations
 * fulfills the Allocator named requirement of the C++ standard
 * usage e.g., std::vector<CMy_Type*, AlignmentAllocator<CMy_Type*, AVX2Alignment>> mSegments; */
...
/* aligned object allocator
 * alignas aligns on the stack, overloaded new aligns on the heap */
