...
namespace factory {
	...
	namespace internal {
		...
		const char* rsCreate_Asynchronnous_Filter = "create_asynchronnous_filter";
		const char* rsCreate_Synchronnous_Filter = "create_synchronnous_filter";
		...
		HRESULT IfaceCalling create_asynchronnous_filter_not_impl(void* id, void* input, void* output, void* filter) { return E_NOTIMPL; }
		HRESULT IfaceCalling create_synchronnous_filter_not_impl(void* id, void* filter) { return E_NOTIMPL; }
		...
		HRESULT IfaceCalling create_asynchronnous_filter_lazy(void* id, void* input, void* output, void* filter) { return factory_lazy_load(rsCreate_Asynchronnous_Filter, id, input, output, filter); }
		HRESULT IfaceCalling create_synchronnous_filter_lazy(void* id, void* filter) { return factory_lazy_load(rsCreate_Synchronnous_Filter, id, filter); }
		...
		void* resolve_not_impl_symbol(const char* symbol_name) {
			...
			if (strcmp(symbol_name, rsCreate_Asynchronnous_Filter) == 0) return reinterpret_cast<void(*)>(internal::create_asynchronnous_filter_lazy);
			if (strcmp(symbol_name, rsCreate_Synchronnous_Filter) == 0) return reinterpret_cast<void(*)>(internal::create_synchronnous_filter_lazy);
			if (strcmp(symbol_name, rsCreate_Synchronnous_Filter) == 0) return reinterpret_cast<void(*)>(internal::create_synchronnous_filter_lazy);
			...
			if (strcmp(symbol_name, rsCreate_Asynchronnous_Filter) == 0) return reinterpret_cast<void(*)>(internal::create_asynchronnous_filter_not_impl);
			if (strcmp(symbol_name, rsCreate_Synchronnous_Filter) == 0) return reinterpret_cast<void(*)>(internal::create_synchronnous_filter_not_impl);
